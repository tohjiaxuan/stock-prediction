...
def build_financials_postgres_taskgroup(dag: DAG) -> TaskGroup:
    ...
    def insert_netincome_init_table(ti):
        """ Inserts scraped historical net income into Postgres table
    ...
    def insert_assets_init_table(ti):
        """ Inserts scraped historical assets into Postgres table
    ...
    def insert_liab_init_table(ti):
        """ Inserts scraped historical liability into Postgres table
    ...
    def insert_equity_init_table(ti):
        """ Inserts scraped historical equity into Postgres table
    ...
    def insert_div_init_table(ti):
        """ Inserts scraped historical dividends into Postgres table
    ...
    def insert_inflation_init_table(ti):
        """ Inserts scraped historical inflation rates into Postgres table
    ...
    def insert_netincome_yearly_table(ti):
        """ Inserts scraped yearly (up-to-date) net income into Postgres table
    ...
    def insert_assets_yearly_table(ti):
        """ Inserts scraped yearly (up-to-date) assets into Postgres table
    ...
    def insert_liab_yearly_table(ti):
        """ Inserts scraped yearly (up-to-date) liability into Postgres table
    ...
    def insert_equity_yearly_table(ti):
        """ Inserts scraped yearly (up-to-date) equity into Postgres table
    ...
    def insert_div_yearly_table(ti):
        """ Inserts scraped yearly (up-to-date) dividends into Postgres table
    ...
    def insert_inflation_yearly_table(ti):
        """ Inserts scraped yearly (up-to-date) inflation rates into Postgres table
    ...
    # Python operator to insert historical assets into table
    ...
    # Python operator to insert historical liabilities into table
    ...
    # Python operator to insert historical equity into table
    ...
    # Python operator to insert historical dividends into table
    ...
    # Python operator to insert historical inflation rates into table
    ...
    # Python operator to insert yearly (up-to-date) net income into table
    ...
    # Python operator to insert yearly (up-to-date) assets into table
    ...
    # Python operator to insert yearly (up-to-date) liabilities into table
    ...
    # Python operator to insert yearly (up-to-date) equity into table
    ...
    # Python operator to insert yearly (up-to-date) inflation_rate into table
    ...
    # Python operator to create Postgres table for historical inflation rate
    ...
    # Python operator to create Postgres table for yearly inflation rate
    ...
    # Python operator to create Postgres table for historical net income
    ...
    # Python operator to create Postgres table for yearly net income
    ...
    # Python operator to create Postgres table for historical assets
    ...
    # Python operator to create Postgres table for yearly assets
    ...
    # Python operator to create Postgres table for historical liabilities
    ...
    # Python operator to create Postgres table for yearly liabilities
    ...
    # Python operator to create Postgres table for historical equity
    ...
    # Python operator to create Postgres table for yearly equity
    ...
    # Python operator to create Postgres table for historical dividends
    ...
    # Python operator to create Postgres table for yearly dividends
    ...
    def if_d_inflation_exists(**kwargs):
        ...
        If D_INFLATION is empty, DAG will take the path to do transformation on historical data.
        If D_INFLATION is not empty, DAG will take the path to do transformation on the yearly (up-to-date) data.
        This is because historical data and yearly data each require different sets & techniques of transformation.
